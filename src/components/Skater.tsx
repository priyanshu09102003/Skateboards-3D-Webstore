...
export function Skater({skater, index}: Props){
  ...
  return (
    <div className='skater group relative flex flex-col items-center gap-4'>
        ...
        <div className="stack-layout overflow-hidden hover:cursor-pointer">

            <PrismicNextImage field={skater.data.photo_background} width={500} imgixParams={{q:20}} alt='' className='scale-110 transform transition-all duration-1000 ease-in-out group-hover:scale-100 group-hover:brightness-75 group-hover:saturate-[0.8]'/>
